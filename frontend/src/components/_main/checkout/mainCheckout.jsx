...
import { SHIPPING_FEE } from 'src/helper/l1';
// dynamic components
  ...
  const loadRazorpayScript = () => {
    return new Promise((resolve, reject) => {
      ...
      script.onerror = () => {
        ...
        setCheckoutError('Failed to load payment gateway');
      };
...
const onSubmit = async (data) => {
  console.log(data)
    ...
    try {
      ...
      const amount = Number(totalWithDiscount || checkout.total);

      const options = {
        key: process.env.NEXT_PUBLIC_RAZORPAY_KEY,
        amount: amount * 100,
        currency: "INR",
        name: "Vivaan Enterprises",
        ...
        handler: function (response) {
          ...
          mutate({
            ...
            razorpayOrderId: response.razorpay_order_id || "ONLY-FRONTEND-NO-ORDER-ID",
