...
export const updateBanner = (data) => {
  return http.put(`/banners/${data.id}`, data);
};
...
export const getWebsiteDetails = () => {
  return http.get('/website-details');
};

export const updateWebsiteDetails = (data) => {
  return http.put('/website-details', data);
};

// export const singleDeleteFile = (publicId) => {
...
export const getNavigationMenu = () => {
  return http.get('/categories/navigation-menu');
};
