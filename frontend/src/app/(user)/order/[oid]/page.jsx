...
export const metadata = {
  ...
  description:
    'Congratulations! Your order has been successfully placed . Thank you for choosing us for your shopping needs. Expect fast processing and delivery. Stay tuned for updates on your order status. Shop more with us!',
  applicationName: 'E-Coms',
  authors: 'Ecoms',
  keywords:
